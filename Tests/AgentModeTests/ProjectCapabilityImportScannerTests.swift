...
final class ProjectCapabilityImportScannerTests: XCTestCase {
    ...
    func testScanSkipsOpenPetAgentGeneratedProjections() throws {
        try writeSkill(
            root: ".claude/skills",
        ...
        try write(
            "generated",
            to: ".claude/skills/generated-claude/.open-pet-agent-generated"
        )
        try writeSkill(
            root: ".agents/skills",
        ...
        try write(
            "generated",
            to: ".agents/skills/generated-codex/.open-pet-agent-generated"
        )
        try write(
            """
        ...
        try write("generated", to: ".open-pet-agent-generated.mcp")
        try write(
            """
